...
public class MainActivityFragment extends Fragment {
    private final static String TAG =  MainActivityFragment.class.getSimpleName() + "-Paid";
    ...
    public void launchAndroidTheJokeReceived(@SuppressWarnings("UnusedParameters") boolean withInterstitialAd, String someDeepJoke) {
        Log.v(TAG, "launchAndroidTheJokeReceived - someDeepJoke="+someDeepJoke);
